...
public class CustomActionService extends JobIntentService {
    ...
    public static void enqueueWork(Context context, int taskId) {
        ...
        intent.setAction(Const.SEND_CUSTOM_SERVICE_ACTION);
        intent.putExtra(TaskID.TASK, taskId);
        enqueueWork(context, CustomActionService.class, JOB_ID, intent);
    }
    ...
    protected void onHandleWork(@NonNull Intent intent) {
        ...
        if (!TextUtils.isEmpty(action) &&
            ...
            boolean isRoaming = NetWorkUtil.isRoaming(this);
            boolean is2G = NetWorkUtil.is2GConnected(this);

...
public class InstallDelayView extends LinearLayout implements View.OnClickListener {
    ...
    private InstallDelayCallback callback;
    ...
    public InstallDelayView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public InstallDelayView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        inflate(getContext(), R.layout.install_delay_dialog_schedule_choice, this);
    ...
    public void setOnItemClickListener(InstallDelayCallback callback) {
